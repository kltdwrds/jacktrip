...
QT_MOC_LITERAL(4, 48, 23), // "signalUdpWaitingTooLong"
QT_MOC_LITERAL(5, 72, 21) // "printUdpWaitedTooLong"

    },
    "UdpDataProtocol\0signalWaitingTooLong\0"
    "\0wait_msec\0signalUdpWaitingTooLong\0"
...
void UdpDataProtocol::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->signalUdpWaitingTooLong(); break;
        case 2: _t->printUdpWaitedTooLong((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            using _t = void (UdpDataProtocol::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&UdpDataProtocol::signalUdpWaitingTooLong)) {
                *result = 1;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject UdpDataProtocol::staticMetaObject = { {
    QMetaObject::SuperData::link<DataProtocol::staticMetaObject>(),
...
// SIGNAL 1
void UdpDataProtocol::signalUdpWaitingTooLong()
{
