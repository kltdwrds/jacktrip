...
QT_MOC_LITERAL(6, 85, 23), // "signalCeaseTransmission"
QT_MOC_LITERAL(7, 109, 6) // "reason"

    },
    "DataProtocol\0signalError\0\0const char*\0"
    "error_message\0signalReceivedConnectionFromPeer\0"
    "signalCeaseTransmission\0reason"
};
...
static const uint qt_meta_data_DataProtocol[] = {
 ...
 // signals: name, argc, parameters, tag, flags
       ...
       6,    0,   41,    2, 0x26 /* Public | MethodCloned */,
...
void DataProtocol::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->signalCeaseTransmission((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 3: _t->signalCeaseTransmission(); break;
        default: ;
        }
        ...
        {
            using _t = void (DataProtocol::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DataProtocol::signalCeaseTransmission)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 2
void DataProtocol::signalCeaseTransmission(const QString & _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
