...
QT_MOC_LITERAL(3, 26, 13) // "error_message"

    },
    "PacketHeader\0signalError\0\0error_message"
};
...
void PacketHeader::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->signalError((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (PacketHeader::*)(const QString & );
...
// SIGNAL 0
void PacketHeader::signalError(const QString & _t1)
{
